/**
 * @description Email Template for Resetting Account Password 
 ...
 */
const resetPasswordTemplate = ({ fullName, url, reactAppUrl }) => {
    return `
                          ...
                          <td style="line-height: 24px; font-size: 16px; box-sizing: border-box; margin: 0; padding: 0;" align="left">
                            <div class="box" style="box-sizing: border-box; background-color: #ffffff; border-radius: 12px; margin: 0; padding: 2em 1em;">
                              ...
                              <header class="text-center" style="text-align: center !important; box-sizing: border-box; margin: 0; padding: 0;">
                                <h1 class="text-center" style="font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; box-sizing: border-box; margin: 0; padding: 0;" align="center">Reset Your Password</h1>
                                ...
                                <p class="text-center" style="line-height: 24px; font-size: 16px; width: 100%; box-sizing: border-box; margin: 0; padding: 0;" align="center">Your request for resetting your account <b style="box-sizing: border-box; margin: 0; padding: 0;">password</b> was noted.</p>
                                <p class="text-center" style="line-height: 24px; font-size: 16px; width: 100%; box-sizing: border-box; margin: 0; padding: 0;" align="center">Click the Link Below to reset your password.</p>
                              </header>
                              ...
                              <p style="line-height: 24px; font-size: 16px; width: 100%; box-sizing: border-box; margin: 0; padding: 0;" align="left">Reset Your Password clicking the button below:</p>
                              <a href="${url}" class="button" style="color: #fff; box-sizing: border-box; text-decoration: none; width: clamp(80px, 100%, 220px); text-align: center; background: #5299d3ff; border-radius: 4px; font-weight: bold; font-size: 1rem; display: block; margin: 1em auto; padding: 1em;">Reset Password</a>
