                              ...
                              <td style="line-height: 24px; font-size: 16px; box-sizing: border-box; margin: 0; padding: 0;" align="left">
                                <div class="box" style="box-sizing: border-box; background-color: #ffffff; border-radius: 12px; margin: 0; padding: 2em 1em;">
                                  ...
                                  <header class="text-center" style="text-align: center !important; box-sizing: border-box; margin: 0; padding: 0;">
                                    <h1 style="font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; box-sizing: border-box; margin: 0; padding: 0;" align="left">Welcome on board!</h1>
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; box-sizing: border-box; margin: 0; padding: 0;" align="left">Hey ${fullName}!</p>
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; box-sizing: border-box; margin: 0; padding: 0;" align="left">Please confirm your email to activate your new account</p>
                                  </header>
                                  ...
                                  <a href="${reactAppUrl}/verifyAccount/authToken=${token}" class="button" style="color: #fff; box-sizing: border-box; text-decoration: none; width: clamp(80px, 100%, 220px); text-align: center; background: #5299d3ff; border-radius: 4px; font-weight: bold; font-size: 1rem; display: block; margin: 1em auto; padding: 1em;">Verify Account</a>
                                  ...
                                  <a href="${reactAppUrl}/verifyAccount/authToken=${token}" style="color: #04f; box-sizing: border-box; text-decoration: none; margin: 0; padding: 0;">${reactAppUrl}/verifyAccount/authToken=${token}</a>
                                  <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%; box-sizing: border-box; margin: 0; padding: 0;" width="100%">
                                    <tbody style="box-sizing: border-box; margin: 0; padding: 0;">
                                      <tr style="box-sizing: border-box; margin: 0; padding: 0;">
                                        <td style="line-height: 20px; font-size: 20px; width: 100%; height: 20px; box-sizing: border-box; margin: 0; padding: 0;" align="left" width="100%" height="20">
